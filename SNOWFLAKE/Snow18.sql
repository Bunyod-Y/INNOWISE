...
GRANT ROLE tasty_de TO USER BUNYODYOKUBOV;
...
GRANT CREATE DATABASE ON ACCOUNT TO ROLE BUNYOD;
SHOW GRANTS TO ROLE BUNYOD;

SELECT CURRENT_USER;

GRANT ROLE BUNYODYOKUBOV TO USER BUNYOD

USE ROLE BUNYOD

CREATE WAREHOUSE BUNYOD_TEST_WH

SHOW GRANTS TO USER BUNYODYOKUBOV
